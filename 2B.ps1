...
.DESCRIPTION
  Temporary fix deployed. Resolves no-internet error during manifest download  
...
function Download-Manifest {
    ...
    Write-Host "  File check... in progress..." -ForegroundColor Magenta
    ...
    Write-WarningMsg "retrieval failed. Retrying. 2B will try hard..."
    ...
    Write-Host "  Acquiring target file..." -ForegroundColor Magenta
