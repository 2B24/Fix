...
function Write-Header {
    ...
    $discordLink = "$esc]8;;https://discord.gg/Y3jebkwx3D$esc\https://discord.gg/Y3jebkwx3D$esc]8;;$esc\"
    Write-Host "  +================================================================+" -ForegroundColor Cyan
    Write-Host "  |                 STEAM MANIFEST DOWNLOADER Fix                  |" -ForegroundColor Cyan
    Write-Host "  |                    Files From  $manifestHubLink                     |" -ForegroundColor Cyan
    Write-Host "  |                                                                |" -ForegroundColor Cyan
